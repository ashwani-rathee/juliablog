...
import { ASHWANI } from "./_BLOG_SETUP";
...
const ARTICLES_LIST: iArticle[] = [
  ...
  //     twitterHandle: "@ashwani-rathee",
  //     author: ASHWANI.name,
  //   },
  // },
  {
    path: '/pages/blog/basic-article-test.tsx',
    featureArticle: true,
    preview: {
        // the author object you created in _BLOG_SETUP file
        author: ASHWANI,
        date: "NOV 17 2022",
        articleTitle: "Basic Article Test",
        shortIntro: "Basics practiced right",
        tags: "julia, image processing",
        thumbnail: "/public/imp_assets/tutorials/how-to-write-first-article.svg",
        category:'deep-learning'
    },
    seo: {
        title: "Basic Article Test",
        description:
